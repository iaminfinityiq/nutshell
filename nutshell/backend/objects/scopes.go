...
func (z *ZeroValues) AccessZeroValue(data_type string) (*Object, bool) {
	return z.Hashmap.ObjectAccess(data_type)
}

func (z *ZeroValues) DeclareZeroValue(data_type string, value *Object) {
	z.Hashmap.Declare(data_type, value, true)
}
