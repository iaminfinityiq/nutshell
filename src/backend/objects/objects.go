...
func (o *Object) Access(attribute_name string) (*Object, bool) {
	if o.DataType == "builtin_function" {
		...
		case "call":
			var new *Object = MakeBuiltInFunction(o.Heap, o.Properties, o.Value.(func(*runtime.Position, *runtime.Position, *[]*ArgumentTuple) runtime.RuntimeResult[*Object]))
			new.Parent = o.HeapIndex
			return new, true
		case "repr":
			var new *Object = MakeString(o.Heap, o.Properties, "<builtin_function>")
			new.Parent = o.HeapIndex
			return new, true
		default:
			return nil, false
