...
func (n *NutshParser) parse_let_variable_declaration() runtime.RuntimeResult[*Statement] {
...
func (n *NutshParser) parse_const_variable_declarartion() runtime.RuntimeResult[*Statement] {
...
func (n *NutshParser) parse_typed_variable_declaration(data_type *Expression, is_constant bool) runtime.RuntimeResult[*Statement] {
	var rt runtime.RuntimeResult[*lexer.Token] = n.expect(lexer.Identifier)
	if rt.Error != nil {
		return runtime.RuntimeResult[*Statement]{
			Result: nil,
...
func (n *NutshParser) parse_type_inference_variable_declaration(is_constant bool) runtime.RuntimeResult[*Statement] {
...
func (n *NutshParser) parse_assignment_expression() runtime.RuntimeResult[*Expression] {
	var rt runtime.RuntimeResult[*Expression] = n.parse_additive_expression()
	if rt.Error != nil {
		return runtime.RuntimeResult[*Expression]{
			Result: nil,
...
func (n *NutshParser) parse_call_expression() runtime.RuntimeResult[*Expression] {
...
func (n *NutshParser) parse_member_expression() runtime.RuntimeResult[*Expression] {
