...
func (m MemberExpression) StartPosition() *runtime.Position {
	return (*m.Parent).StartPosition()
}

func (m MemberExpression) EndPosition() *runtime.Position {
	return m.Member.EndPosition
}

func (m MemberExpression) Kind() int {
	return MemberExpr
}

func (m MemberExpression) ExpressionConfirm() {
